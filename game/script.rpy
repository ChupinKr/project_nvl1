...
label start:
    ...
    f @smile_shy_hold "Я призвала тебя из твоего мира, потому что мне нужна поддержка. Я заметила твои \"достоинства\" невооруженным глазом, поверь, я знаю, что не ошиблась." with dissolve
    f "Итак, тебе нужно развратить это место, мужчины вымирают, я, как богиня любви, обязана спасти людей, но я не могу действовать собственными руками."
    f @smile "Поэтому я призвала тебя~" with dissolve
    p "Что? Но я не..."
    f @closed_smile "Да, да, да, ты очень польщем и благодарен за такую возможность, я всё понимаю!" with dissolve

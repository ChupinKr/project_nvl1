...
label start:
    ...
    f "Возможно, ты станешь великим, даже более великим, чем сам король Эльтираниии~"  
    f "О, ты не знаешь? Это страна, в которой ты переродишься. Очень интересное место, поверь мне~"  
    ...
    f "А теперь, [hero_name], ты стоишь перед серьёзнейшим выбором в твоей новой жизни! Возможно, он будет даже приятным~"

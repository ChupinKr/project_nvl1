init python:
    ...
    blessing_stamina = Blessing(
        ...
        description="Увеличивает твою \nвыносливость и физическую стойкость, \nпозволяя дольше сражаться и выдерживать больше урона.",
        grade=0  #грейд
    )
    blessing_magic = Blessing(
        name="Магический Потенциал",
        description="Открывает твой \nмагический потенциал, позволяя \nиспользовать магию и увеличивая ману.",
        grade=0,  #грейд
        spell_copy=False # Копирования чужого заклинания
    )
    blessing_seduction = Blessing(
        name="Дар Соблазнителя",
        description="Увеличивает твою \nхаризму и магнетизм, позволяя влиять \nна людей и манипулировать ими.",
        grade=0  #грейд
    )

    blessing_nothing = Blessing(
        name="Дар свободы", #от линейного сюжета
        description="Ничего не увеличивает, \nлишь делает жизнь немного сложнее.",
        grade=0  #грейд
    )

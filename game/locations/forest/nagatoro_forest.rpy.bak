...
label nagatoro_forest_quests:
    ...
    menu:
        "Убить гоблинов в лесу.":
            p "Убить несколько гоблинов в лесу, чтобы показать, что здесь не место для трусов."
            show nag happy
...
label battle_win_forest_nagatoro:
    ...
    #Уже может посетить гильдию
        ...
        p "Ну, может, ты и боялась, что я не выдержу."
        show nag smile_closed
        nag "Может, и была не уверена, стоит ли показывать все карты. Но теперь, когда ты доказал, что в тебе есть потенциал, можешь смело идти в Гильдию."
        jump guild_nagatoro

label guild_nagatoro:
    "Ты следуешь за Нагаторо по пыльным коридорам Гильдии. Здесь тебя ждут новые испытания и уроки, которые помогут тебе стать настоящим бойцом."
    #TODO replace to guild folder
    return

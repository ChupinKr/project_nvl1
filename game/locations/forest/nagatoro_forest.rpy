    ...
    if not canVisit("guild"):
        ...
        menu:
            ...
            "Подожду, пока он устанет, и нападу.": 
                ...
                nag "Наивно. Хороший мечник убьёт тебя задолго до усталости."
        ...
        show nag neutral with dissolve
        nag "Поэтому я веду тебя в Гильдию. Там из тебя сделают настоящего воина, если только ты не останешься полным неудачником."

...
label rapunzel_first_time_blessing:
    ...
    "Она буквально пожирает меня взглядом. Её голубые глаза блестят любопытством, а в голосе звучит лёгкая хрипотца. Ветер слегка колышет её длинные золотистые волосы, создавая ощущение, будто она живое воплощение греха."

    show rapunzel curious
    r "Я редко встречаю кого-то в этих местах... Ты выглядишь потерянным... или, может, ты просто ищешь приключений?"  
    r "Ммм… твоя аура… она… чертовски возбуждает. Откуда в тебе такая дьявольская харизма?"  
    ...
    show rapunzel grin
    r "Я должна знать... насколько ты хорош в управлении женщинами!"  
    show rapunzel lick_lips  
    ...
    "Проверка? Значит, это действительно игра. Ладно, посмотрим, насколько далеко она готова зайти."
    ...
    menu:
        "Подойти, взять её за руку и прошептать что-то возбуждающее на ухо.":
            ...
            show rapunzel blush
            r "О-о-о… звучит дерзко... Мне уже интересно, что ты бы сказал."
    ...
    show rapunzel giggle
    r "Знаешь, мне нравится твой стиль. Но что дальше?"  
    ...
    menu:
        "Ты выглядишь так, будто ждала именно меня.":
            ...
            "Её губы дрогнули, а ресницы чуть дрогнули. Кажется, мой ответ ей определённо понравился."
        ...
        "Знаешь, мне нужно твое мнение... какая поза лучше всего подходит для страстного поцелуя?":
            ...
            show rapunzel surprised
            r "Хах! Оригинально! Теперь ты вынуждаешь меня представить это…"

            "Она явно застигнута врасплох. Я вижу, как её взгляд становится чуть мечтательным, и она невольно проводит пальцем по нижней губе."
        ...
        "Я могу предложить тебе вечер, который ты не забудешь.":
            ...
            "Она смотрит на меня с явным любопытством. Похоже, я точно пробудил в ней интерес."
    ...
    "В её голосе звучит вызов. Она подаётся вперёд, так что её лицо оказывается почти вплотную к моему. Я чувствую запах её волос, лёгкий аромат трав и чего-то сладковатого. Если я пойду с ней, это определённо не закончится просто разговором."

    menu:
        "Согласиться и пойти с ней":
            p "Ладно, я заинтригован. Веди!"
            show rapunzel excited
            r "О, это будет весело~ Надеюсь, ты не разочаруешь меня..."
...
label first_time_rapunzel_no_blessing:
    ...
    menu:
        "Я бы посмотрел тебе в глаза и сказал: 'Ты - самое красивое, что я видел сегодня'.":  
            ...
            show rapunzel blush  
            r "Ох… это мило… но тебе придется постараться сильнее."
        ...
        "Я бы подсел поближе и спросил, не хочешь ли ты приключений этим вечером.":  
            ...
            show rapunzel grin  
            r "Хах, люблю мужчин, которые не тратят время на пустые разговоры~"  
        ...
        "Я бы просто провел пальцами по твоему запястью, не говоря ни слова.":  
            ...
            show rapunzel surprised  
            r "О-о-о… Ты любишь играть на нервах, да?.. Интересный подход."
...
label rapunzel_not_first_time: 
    ...
    menu:
        ...
        "Спросить, есть ли у нее задание":
            ...
            menu:
                "Собрать особые грибы":
                    ...
                    $ active_quest = "Сбор грибов для Рапунцель"
                ...
                "Приглашать девушек работать в борделе":
                    ...
                    $ active_quest = "Приглашать дам для Рапунцель"
                    jump visit_rapunzel_ruined_temple

...
label elsa_not_first_time:
    ...
    menu:
        ...
        "Я бы хотел узнать, где здесь библиотека":
    ...
    menu:
        ...
        "Я готов собирать магические материалы.":
            ...
            $ active_quest = "Сбор материалов для [e.name]"
            jump ruined_temple

...
label visit_nagatoro_ruined_temple:
    ...
    if first_time_nagatoro:
        ...
        nag "Ну что у нас тут? Заблудившийся мальчик?"
        nag "Или ты осознанно решил появиться в месте, где можешь встретить кого-то… опасного?"
        ...
        menu:
            ...
            "Не связываться": 
                ...
                show nag grin
                nag "О, какой благоразумный."
                nag "Но запомни, я не забываю тех, кто заинтересовал меня."
                nag "В следующий раз я не позволю тебе уйти так легко."
    ...
    # не первая встреча
        ...
        nag "Ты вернулся. Надо же, не ожидала увидеть тебя после нашей последней встречи."
        nag "Или ты пришёл за чем-то конкретным? Я могу предложить тебе несколько вариантов."

        p "Я думал над тем, что мне делать дальше."

        show nag neutral
        nag "Хм, если ты хочешь, я могу предложить тебе тренировки. Я не возражаю, если ты хочешь стать сильнее."
        nag "Или, может, ты захочешь выполнить задание. У меня есть парочка задач, которые могут быть тебе по плечу."
...
label nagatoro_ruined_temple_quests:
    ...
    nag "Хм, у меня есть пара вариантов."

    menu:
        "Убить гоблинов в лесу.": 
            p "Убить несколько гоблинов в лесу."
            nag "Гоблины не такие уж и слабые. Ты уверен, что справишься?"
            menu:
                "Принять квест":
                    nag "Надеюсь на тебя"
        ...
        "Зачистить часть леса от диких зверей.": 
            ...
            nag "Хороший выбор. Там полно опасных существ, будь осторожен."
            menu:
                "Принять квест":
                    nag "Надеюсь на тебя"
        ...
        "Уничтожить банду разбойников на восточной дороге.": 
            ...
            nag "Банда действительно угрожает путникам. Это задание стоит того, чтобы им заняться."
            menu:
                "Принять квест":
                    nag "Надеюсь на тебя"
...
label battle_win_ruined_temple_nagatoro:
    ...
    nag "Уххх, а ты неплох для новичка."
    nag "Но не обольщайся. Ты победил только потому, что я дала тебе такой шанс."
    ...
    if not can_visit_guild:
        ...
        show nag neutral
        nag "Твой противник – маг, а ты не владеешь магией. Как поступишь?"
        ...
        nag "Ещё один."
        show nag neutral
        nag "Ты оказался безоружным против мечника. Что сделаешь?"
        ...
        show nag grin
        nag "Знаешь... ты понятия не имеешь, как правильно сражаться."

        show nag neutral
        nag "Это не оскорбление. Это факт."
        nag "Ты победил меня, но это не значит, что ты хорош в бою. Ты просто удачно двигался."
        
        nag "Но если ты хочешь жить, тебе нужны навыки."

        show nag neutral
        nag "Поэтому ты идёшь в Гильдию. Там из тебя сделают настоящего воина."
        
        p "Ты так уверена, что я захочу идти?"

        show nag grin
        nag "О, уверена."
        nag "Я не из тех, кто оставляет перспективных бойцов без внимания."
        nag "Ты мне интересен, но только пока у тебя есть потенциал."
        
        show nag smile_closed
        nag "К тому же, все успехи должны быть вознаграждены, не так ли?"
        
        p "Ты о чём?"

        show nag laugh
        nag "Ха-ха! Не бойся, я не требую многого."
        nag "Но кто знает... если ты будешь стараться, может, получишь что-то особенное."

        show nag normal
        nag "А теперь пошли. Время тебе познакомиться с Гильдией."

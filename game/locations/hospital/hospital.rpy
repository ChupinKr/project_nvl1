...
label hospital:
    ...
    if first_time_sakura:
        ...
        s "Раньше лечение было бесплатным, но теперь, когда величайшего мага с нами нет, ремонт и магические камни для этого оборядования стоят огромных денег, так что нам пришлось брать плату за лечение."

...
label market:
    ...
    if first_visit_market:
        ...
        menu:
            ...
            "Сладкое":
                $ holo_choices += 1
                h @smile_closed_eyes "О-хо-хо! Значит, ты любишь мёд и спелые яблоки? Хороший вкус, но не обольщайся — я делиться не стану!"
        h "Теперь серьёзный вопрос. Какое качество в людях ты ценишь больше всего?"
        menu:
            "Выбери качество"
            "Честность":
                $ holo_choices += 1
                h @smile_closed_eyes "Честность? Ох-хо, ты что, в сказку попал? Честные торговцы встречаются только в легендах."
            "Храбрость":
        ...
        menu:
            ...
            "Умные, хитрые и с характером":
                $ holo_choices += 1
                h @smile_shy "О-хо-хо! Да ты разбираешься в хороших вещах, мальчишка. Может, не так уж ты и безнадёжен?"
            "Красивые":

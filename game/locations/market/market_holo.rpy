...
label h_root_masturbate(is_preview=False):
    ...
    scene bg h_masturbate1 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg h_masturbate2 at bg_size with dissolve 
    call hide_dialog 
    ...
    scene bg h_masturbate3 at bg_size with dissolve  
    call hide_dialog
    ...
    scene bg h_masturbate4 at bg_size with dissolve
    call hide_dialog  
    "[h.name] выпрямляется, её руки медленно скользят по бокам юбки..."  
    h "Ну? Интересно, что под ней?"  

    scene bg h_masturbate5 at bg_size with dissolve  
    call hide_dialog
    ...
    scene bg h_masturbate6_1 at bg_size with dissolve  
    call hide_dialog
    ...
    scene bg h_masturbate6_2 at bg_size with dissolve  
    call hide_dialog
    ...
    scene bg h_masturbate9 at bg_size with dissolve  
    call hide_dialog
    ...
    scene bg h_masturbate10 at bg_size with dissolve 
    call hide_dialog 
    ...
    scene bg h_masturbate11 at bg_size with dissolve  
    call hide_dialog
    ...
    scene bg h_masturbate12 at bg_size with dissolve  
    call hide_dialog
    ...
    scene bg h_masturbate13 at bg_size with dissolve  
    call hide_dialog
    ...
    scene bg h_masturbate14 at bg_size with dissolve  
    call hide_dialog
    ...
    scene bg h_masturbate15 at bg_size with dissolve  
    call hide_dialog
    ...
    scene bg h_masturbate16 at bg_size with dissolve  
    call hide_dialog
    ...
    scene bg h_masturbate16_rep at bg_size with dissolve  
    pause .5
    scene bg h_masturbate16_rep2 at bg_size with dissolve  
    pause .5
    scene bg h_masturbate16_rep at bg_size with dissolve  
    pause .4
    scene bg h_masturbate16 at bg_size with dissolve  
    ...
    scene bg h_masturbate17_cum1 at bg_size with flash 
    call hide_dialog 
    ...
    scene bg h_masturbate17_cum2_test at bg_size with flash  
    call hide_dialog
    "Сперма бьёт сильнее, и [h.name] выглядит немного испуганной, но не отстраняется. Её глаза широко раскрыты."  
    h "Ох! Это... так много..."  

    scene bg h_masturbate17_cum3 at bg_size with flash  
    call hide_dialog
    ...
    scene bg h_masturbate17_cum4 at bg_size with dissolve  
    call hide_dialog
    ...
    scene bg h_masturbate17_cum5 at bg_size with dissolve  
    call hide_dialog
    mind "Она наклоняется ближе ко мне, её рука всё ещё держит мой пульсирующий член."  

    scene bg h_masturbate17_cum6 at bg_size with dissolve  
    call hide_dialog
    ...
    scene bg h_masturbate18 at bg_size with dissolve 
    call hide_dialog 
    ...
    scene bg h_masturbate19_t_0 at bg_size with dissolve  
    call hide_dialog
    ...
    scene bg h_masturbate19_t_0 at bg_size with dissolve  
    pause .5
    scene bg h_masturbate19_t_1 at bg_size with dissolve  
    pause .5
    scene bg h_masturbate19_t_2 at bg_size with dissolve  
    pause .4
    scene bg h_masturbate19_t_1 at bg_size with dissolve  
    pause .4
    scene bg h_masturbate19_t_0 at bg_size with dissolve  
    ...
    scene bg h_masturbate19_t_0 at bg_size with dissolve
    pause .2
    scene bg h_masturbate19_t_1 at bg_size with flash
    pause .2
    scene bg h_masturbate19_t_2 at bg_size with flash
    call hide_dialog

    scene bg h_masturbate20_t_cum1 at bg_size with flash  
    call hide_dialog
    ...
    scene bg h_masturbate20_t_cum2 at bg_size with flash 
    call hide_dialog 
    ...
    scene bg h_masturbate20_t_cum3 at bg_size with flash 
    call hide_dialog 
    ...
    scene bg h_masturbate20_t_cum4 at bg_size with flash  
    call hide_dialog
    ...
    scene bg h_masturbate20_t_cum5 at bg_size with flash  
    call hide_dialog
    ...
    if my_holo_love < 70 and not is_preview:
    ...
    scene bg h_masturbate21_t at bg_size with dissolve 
    call hide_dialog 
...
label h_root_titfuck(is_preview=False):
    ...
    hide h with fade
    show bg h_titfuck1 at bg_size with dissolve
    call hide_dialog
    ...
    show bg h_titfuck2 at bg_size with dissolve
    call hide_dialog
    ...
    show bg h_titfuck16 at bg_size with dissolve
    call hide_dialog
    "[h.name] неуверенно обхватывает грудями твой твердный член"
    mind "Как же приятно."
    
    show bg h_titfuck17 at bg_size with dissolve
    call hide_dialog
    ...
    show bg h_titfuck18 at bg_size with dissolve
    call hide_dialog
    "[h.name] сжимает член своими грудями"
    p "А-ах... Хорошая девочка..."
    
    show bg h_titfuck19_ at bg_size with dissolve
    call hide_dialog
    ...
    show bg h_titfuck20_1 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg h_titfuck20_2 at bg_size with dissolve  
    pause .5
    scene bg h_titfuck20_3 at bg_size with dissolve  
    pause .5
    scene bg h_titfuck20_4 at bg_size with dissolve  
    pause .4
    scene bg h_titfuck20_3 at bg_size with dissolve  
    pause .4
    scene bg h_titfuck20_2 at bg_size with dissolve  
    pause .3
    scene bg h_titfuck20_1 at bg_size with dissolve  
    pause .3
    scene bg h_titfuck20_2 at bg_size with dissolve  
    pause .3
    scene bg h_titfuck20_3 at bg_size with dissolve  
    ...
    scene bg h_titfuck20_4 at bg_size with dissolve  
    pause .1
    scene bg h_titfuck20_3 at bg_size with flash  
    pause .1
    scene bg h_titfuck20_4 at bg_size with flash  

    
    scene bg h_titfuck21_cum1 at bg_size with flash  
    call hide_dialog
    "Струя спермы вырывается из твоего члена"
    
    scene bg h_titfuck21_cum2 at bg_size with flash  
    call hide_dialog
    h "Ааааааа..."
    "[h.name] открыла ротик и высунула язык"
    mind "Она уже знает, что меня это заводит сильнее всего."

    scene bg h_titfuck21_cum3 at bg_size with flash  
    call hide_dialog
    p "Арргх!"
    "Еще большее количество спермы выходит из тебя, [h.name] будто доит твой член своими грудями"

    scene bg h_titfuck21_cum4 at bg_size with flash  
    call hide_dialog
    "[h.name] не смогла поймать всё в ротик, теперь все ее лицо покрыто твоим семенем"
    p "А-а-ах.."
    
    scene bg h_titfuck21_cum5 at bg_size with flash  
    call hide_dialog
    "Поток спермы остановился, сперма стекает с ее лица"
    h "Спасибо за угощение~~"
    
    scene bg h_titfuck21_cum6 at bg_size with dissolve 
    call hide_dialog 
...
label h_root_blowjob(is_preview=False):
    ...
    p "Да..."
    call h_root_blowjob_continue(is_preview)
    return
...
label h_root_anal(is_preview=False):
    ...
    p "Теперь ты готова."
    h "Сейчас ты меня..."
    call h_root_anal_continue(is_preview)
    return

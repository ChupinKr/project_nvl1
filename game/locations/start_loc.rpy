...
label blessings_choice:
    ...
    show screen daytime
    "INFO: в левом верхнем углу ты видишь текущий день и время суток"
    "INFO: в этой игре нужно гриндить деньги, за деньги ты можешь получить многое"
    "INFO: тебе необходимо спать, спать на улице не самый приятный вариант, но для начала сойдет, лучше всего арендовать комнату в таверне, поверь, это выгодно"
    "INFO: советую навестить [f.name] в ближайшее время и попросить помощи, ее храм находится за лесом"
    jump forest

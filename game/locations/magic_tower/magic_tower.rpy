...
label magic_tower_first_visit:
    ...
    show mer neutral at center with dis5
    ...
    mer surprised "[hero_name] выглядит так, будто впервые видит магию."
    ...
    mer smirk "О, слышал? Какая редкость. Давай проверим, что ты знаешь."
    ...
    mer surprised "Поздравляю, ты полностью провалил все три проверки."
    p "Ну, я хотя бы пытался!"

    mer smirk "Да-да. Но в этот раз попытки не считаются. "
    mer "Хотя... Возможно, у тебя есть потенциал. "
    mer "Где-то глубоко-глубоко под слоем бесполезности."

    e smirk "Я знала, что это будет весело."

    mer neutral "Ладно, раз уж Эльза тебя сюда привела, я дам тебе шанс. "

...
label rapunzel_brothel_first_visit:
    ...
    p "БУДУ"
    p "ЭТИМ ЗАНИМАТЬСЯ!!!"
    mao "Тише, тише, а то нас в баре услышат. Тебе и не надо, я говорю о том, чтобы приглашать девушек работать у нас."
    mao "Звучит интереснее, да? А мы тебе монет отсыпем за каждую."
    p "А как же стража? Если меня поймают? Или вовсе решат казнить?"
    mao "А ты хорошо тогруешься, [hero_name]! Убедил, бонусом посещение моего борделя бесплатно!"
    p "ДОГОВОРИЛИСЬ!" 
    $can_invite_brothel = True
    $customNotify("Теперь вы можете приглашать девушек на работу в Бордель")
    mao "Понимаю, что дело это не быстрое, особенно для красавиц здешних. Но я верю в тебя!"
    mao "Когда поймешь, что у тебя есть шанс пригласить девушку работать у нас - можешь подойти ко мне и взять пригласительный на работу, иначе девушка никак к нам не попадет."

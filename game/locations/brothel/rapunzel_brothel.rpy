...
label rapunzel_brothel:
    ...
    if first_time_visit_room_rapunzel:
        ...
        scene bg brothel_private at bg_size with dissolve
...
label r_root_masturbate(is_preview=False):
    ...
    scene bg r_masturbate7 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_masturbate8 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_masturbate10 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_masturbate11 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_masturbate11_2 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_masturbate11_3 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_masturbate12 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_masturbate13 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_masturbate14 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_masturbate15 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_masturbate16_17 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_masturbate18 at bg_size with dissolve
    call hide_dialog
    ...
    if my_rapunzel_love < 70 and not is_preview:
    ...
    scene bg r_masturbate19 at bg_size with dissolve  
    call hide_dialog
    ...
    scene bg r_toy_anal1 at bg_size with dissolve  
    call hide_dialog
    ...
    scene bg r_toy_anal2 at bg_size with dissolve 
    call hide_dialog 
    mind "Она будто на другой планете, полностью погрузившись в наслаждение."  
    r "Ммм... Да... Ещё глубже..."  
    p "Я теряю голову..."  

    if my_rapunzel_love < 90 and not is_preview:
    ...
    scene bg r_dick_anal1 at bg_size with vpunch 
    call hide_dialog
    ...
    scene bg r_dick_anal2 at bg_size with dissolve
    pause .2
    scene bg r_dick_anal3 at bg_size with dissolve
    pause .2
    scene bg r_dick_anal4 at bg_size with dissolve
    pause .2
    scene bg r_dick_anal3 at bg_size with dissolve
    pause .2
    scene bg r_dick_anal2 at bg_size with dissolve
    ...
    scene bg r_dick_anal5 at bg_size with dissolve
    call hide_dialog
    r "Еби меня, [hero_name], еще жесче!"
    
    mind "Как я могу ослушаться?"
    scene bg r_dick_anal6 at bg_size with flash
    call hide_dialog
    "Ты целиком вгоняешь свой член в ее анус"
    r "Аааааааах!!!"
    r "Да! Да! Да! Да! Да!"

    scene bg r_dick_anal7 at bg_size with flash
    call hide_dialog
    "Ты продолжаешь жестко ебать [r.name], кажется она начала терять сознание"
    
    scene bg r_dick_anal8 at bg_size with flash
    call hide_dialog
    ...
    p "Аргх.."
    scene bg r_dick_anal9 at bg_size with flash
    call hide_dialog
    "Сперма попала на тело [r.name] и стекает на простыни"
    
    scene bg r_dick_anal10 at bg_size with flash
    call hide_dialog
...
label r_root_blowjob(is_preview=False):
    ...
    hide r with fade
    scene bg r_pre_1 at bg_size with dissolve
    call hide_dialog
    "[r.name] снимает с тебя штаны и перед ее лицом оказывается твой огромный член"
    scene bg r_holding_look_dick_surprised2 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_suck_2_ahegao at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_suck_9 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_suck_10 at bg_size with dissolve
    call hide_dialog
    "Ее глаза начинают закрываться.."
    
    scene bg r_suck_11 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_suck_15 at bg_size with dissolve
    call hide_dialog
    p "А-а-ааа!"
    r "Мммррррффффф!!!"

    scene bg r_suck_16 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_suck_18 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_suck_19 at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_suck_26 at bg_size with dissolve
    call hide_dialog
...
label r_root_fuck(is_preview=False):
    ...
    scene bg r_blowjob_start at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_ass_tease at bg_size with dissolve
    call hide_dialog
    ...
    scene bg r_vaginal_start at bg_size with vpunch
    call hide_dialog
    ...
    scene bg r_vaginal_1 at bg_size with dissolve
    pause .2
    scene bg r_vaginal_2 at bg_size with dissolve
    pause .2
    scene bg r_vaginal_3 at bg_size with dissolve
    pause .2
    scene bg r_vaginal_2 at bg_size with dissolve
    pause .1
    scene bg r_vaginal_1 at bg_size with dissolve
    ...
    scene bg r_vaginal_2 at bg_size with dissolve
    pause .03
    scene bg r_vaginal_3 at bg_size with flash
    call hide_dialog
    ...
    scene bg r_vaginal_climax at bg_size with flash
    call hide_dialog
    ...
    scene bg r_anal_start at bg_size with vpunch
    call hide_dialog
    ...
    scene bg r_anal_1 at bg_size with dissolve
    pause .2
    scene bg r_anal_2 at bg_size with dissolve
    pause .2
    scene bg r_anal_3 at bg_size with dissolve
    pause .2
    scene bg r_anal_2 at bg_size with dissolve
    pause .1
    scene bg r_anal_1 at bg_size with dissolve
    ...
    scene bg r_anal_2 at bg_size with dissolve
    pause .03
    scene bg r_anal_3 at bg_size with flash
    call hide_dialog

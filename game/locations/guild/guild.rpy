...
label guild:
    ...
    if first_time_guild:
        ...
        show nag neutral at right with dissolve
        ...
        show d smirk at center with dissolve
        ...
        menu:
            d "Твоя задача — продемонстрировать силу и решительность!"
            "Ударить её":

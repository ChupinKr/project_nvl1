...
label guild:
    ...
    if first_time_guild:
        ...
        d @smile "О-о-о, значит, ещё одна молодая душа ищет путь истинного воина? Великолепно! Я, Лала... кхм, [d.name], приму тебя в гильдию! Но сперва..."

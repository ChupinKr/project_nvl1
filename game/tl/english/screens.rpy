...
translate english strings:
    ...
    old "Б.Сохр"
    new "Q.Save"  # Short for "Quick Save"

    # game/screens.rpy:520
    old "Б.Загр"
    new "Q.Load"  # Short for "Quick Load"
    ...
    old "Boosty"
    new "Boosty"  # Likely a platform name, left as-is

    # game/screens.rpy:593
    old "Patreon"
    new "Patreon"  # Platform name, left as-is
    ...
    new "Advances dialogue without allowing choices."
    ...
    new "Rolls back to an earlier point in the game."
    ...
    new "Enables the supported {a=https://www.renpy.org/l/voicing}text-to-speech synthesizer{/a}."
